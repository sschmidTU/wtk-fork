...
kanji: 鼎
keyword: tripod
elements: one-sided2, one-sided, waiter with wine on tray, eye, straightened hook, axe, ax
elementsTree: l(t(straightened hook, ceiling, l(drop, stick)), sun, c(straightened hook, axe)) // unfortunately, this contains some unique elements/strokes. the straightened hook on the right is reversed.
structureVague: yes
strokes: 13
on-yomi: テイ
permalink: /鼎/
