...
kanji: 踪
keyword: trail
elements: leg, wooden leg, mouth, mending, mend, religion, perfect, house, show, beginning, two, human legs
elementsTree: l(leg, perfect)
elementsPureExtra: show
strokes: 15
image: E8B8AA
on-yomi: ショウ、 ソウ
kun-yomi: あと
...
prev: 踏
next: 骨
comments: The right part is basically 'perfect', except it ends with small instead of human legs. This seems to be the only occasion so far where that's the case, using the 'show' element instead of 'beginning' after 'house' (perfect = house + beginning)
---
