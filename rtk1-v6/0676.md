...
elementsTree: l(state of mind, t(left, moon)) // the right part could be made into its own element (left-handed?) as it occurs twice, but it's still rare and never on its own.
elementsPureExtra: left-handed
strokes: 12
image: E683B0
on-yomi: ダ
permalink: /惰/
